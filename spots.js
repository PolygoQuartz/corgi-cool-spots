...
const SPOTS = [
  ...
  },
  {
    ...
    "water": {
      ...
      "note": "犬の入水に関する公式明文は見当たらず（2026-08-03時点）。園のペット規定はリードまたはケージ・建物内は抱っこ（公式FAQ）。訪問時はリードのまま川遊び・泳ぎができた（現地確認2026-08-01）"
    },
    "parking": [
      {
        "name": "園内駐車場",
    ...
    "photo": {
      ...
      "credit": "現地撮影（2026-08-01）"
    },
    "notes": "童謡『夕焼小焼』ゆかりの八王子市の入園施設。園内を北浅川が流れる。開園9:00〜16:30（11〜2月は16:00まで・GW/7-8月の土日祝/お盆は18:00まで）・年中無休。夏休みの川遊び場入口付近は混雑するが、奥に静かな区画あり（現地確認2026-08-01）",
    "official": {
