...
const RESTAURANTS = {
  ...
  "r076": {
    ...
    "hours": {
      "open": "10:00〜20:00",
      "closed": "火・水曜定休",
      "note": "⚠️ 改装のため休業中・再開日未定（確認日2026-08-04）"
    }
  },
  "r077": {
    "id": "r077",
    ...
    "hours": {
      "open": "11:00〜21:00",
      "closed": "水曜定休",
      "note": "⚠️ 営業状況が確認できず（食べログ掲載保留・確認日2026-08-04）。訪問前に要確認"
    }
  },
  "r079": {
    "id": "r079",
  ...
  "r057": {
    ...
    "hours": {
      "open": "11:00〜21:30",
      "closed": "月曜定休",
      "note": "改修休業を経て2026年4月リニューアルオープン。営業形態・メニューが変わっている可能性あり（要確認・確認日2026-08-04）"
    }
  },
  "r137": {
    "id": "r137",
