...
const SPOTS = [
  {
    ...
    "category": "river",
    "area": "神奈川県藤沢市",
    "congestion": {"factor": 1.5, "months": [7, 8], "weekendOnly": true, "note": "夏週末昼前後はR134渋滞（鎌倉区間の実測で最大3倍）"},
    "lat": 35.3645,
    "lng": 139.45,
    "elevation_m": 5,
    "driveMin": 50,
  ...
  },
  {
    ...
    "category": "river",
    "area": "東京都青梅市",
    "congestion": {"factor": 1.1, "months": [7, 8], "weekendOnly": true, "note": "夏週末は青梅市街で軽い渋滞（行き午前は軽微）"},
    "lat": 35.7847,
    "lng": 139.2568,
    "elevation_m": 180,
    "driveMin": 70,
  ...
  },
  {
    ...
    "category": "river",
    "area": "千葉県君津市",
    "congestion": {"factor": 1.15, "weekendOnly": true, "note": "週末朝のアクアライン混雑（下り行きは軽め・ピークは早朝5〜7時）"},
    "lat": 35.2445,
    "lng": 139.9996,
    "elevation_m": 100,
    "driveMin": 70,
  ...
  },
  {
    ...
    "category": "river",
    "area": "埼玉県秩父郡長瀞町",
    "congestion": {"factor": 1.25, "months": [7, 8], "weekendOnly": true, "note": "夏週末は関越・R140渋滞"},
    "lat": 36.094,
    "lng": 139.1113,
    "elevation_m": 130,
    "driveMin": 130,
  ...
  },
  {
    ...
    "category": "sea",
    "area": "神奈川県横須賀市",
    "congestion": {"factor": 1.3, "months": [7, 8], "weekendOnly": true, "note": "夏週末は三浦方面渋滞（縦貫道開通で以前より緩和）"},
    "lat": 35.2508,
    "lng": 139.742,
    "elevation_m": 2,
    "driveMin": 70,
  ...
  },
  {
    ...
    "category": "sea",
    "area": "静岡県下田市",
    "congestion": {"factor": 1.6, "months": [7, 8], "weekendOnly": true, "note": "夏週末はR135渋滞（熱海以南・お盆は更に悪化）"},
    "lat": 34.691,
    "lng": 138.979,
    "elevation_m": 3,
    "driveMin": 180,
  ...
  },
  {
    ...
    "category": "lake",
    "area": "山梨県山中湖村",
    "congestion": {"factor": 1.25, "weekendOnly": true, "note": "週末は中央道相模湖付近の渋滞（連休は大幅悪化）"},
    "lat": 35.4149,
    "lng": 138.8909,
    "elevation_m": 982,
    "driveMin": 100,
