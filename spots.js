...
const SPOTS = [
  {
    ...
    "category": "river",
    "area": "神奈川県藤沢市",
    "congestion": {"factor": 1.2, "months": [7, 8], "weekendOnly": true, "peak": {"from": 10, "to": 18, "factor": 1.8}, "note": "夏週末のR134渋滞（10〜18時が激混み・鎌倉区間実測で最大3倍）"},
    "lat": 35.3645,
    "lng": 139.45,
    "elevation_m": 5,
    "driveMin": 50,
  ...
  },
  {
    ...
    "category": "river",
    "area": "東京都青梅市",
    "congestion": {"factor": 1.05, "months": [7, 8], "weekendOnly": true, "peak": {"from": 9, "to": 13, "factor": 1.2}, "note": "夏週末は青梅市街で渋滞（午前遅めが混みやすい）"},
    "lat": 35.7847,
    "lng": 139.2568,
    "elevation_m": 180,
    "driveMin": 70,
  ...
  },
  {
    ...
    "category": "river",
    "area": "千葉県君津市",
    "congestion": {"factor": 1.05, "weekendOnly": true, "peak": {"from": 5, "to": 8, "factor": 1.3}, "note": "週末のアクアライン混雑（下りは早朝5〜8時がピーク・以降は軽い）"},
    "lat": 35.2445,
    "lng": 139.9996,
    "elevation_m": 100,
    "driveMin": 70,
  ...
  },
  {
    ...
    "category": "river",
    "area": "埼玉県秩父郡長瀞町",
    "congestion": {"factor": 1.1, "months": [7, 8], "weekendOnly": true, "peak": {"from": 6, "to": 11, "factor": 1.4}, "note": "夏週末の関越・R140渋滞（朝6〜11時がピーク）"},
    "lat": 36.094,
    "lng": 139.1113,
    "elevation_m": 130,
    "driveMin": 130,
  ...
  },
  {
    ...
    "category": "sea",
    "area": "神奈川県横須賀市",
    "congestion": {"factor": 1.15, "months": [7, 8], "weekendOnly": true, "peak": {"from": 10, "to": 17, "factor": 1.4}, "note": "夏週末の三浦方面渋滞（日中がピーク・縦貫道開通で以前より緩和）"},
    "lat": 35.2508,
    "lng": 139.742,
    "elevation_m": 2,
    "driveMin": 70,
  ...
  },
  {
    ...
    "restaurants": [
      {"ref": "r121", "note": "車約12分・三浦海岸沿いのオープンデッキ"},
      {
        "ref": "r063",
  ...
  },
  {
    ...
    "category": "sea",
    "area": "静岡県下田市",
    "congestion": {"factor": 1.2, "months": [7, 8], "weekendOnly": true, "peak": {"from": 9, "to": 16, "factor": 1.8}, "note": "夏週末のR135渋滞（9〜16時が激混み・早朝出発なら軽い・お盆は更に悪化）"},
    "lat": 34.691,
    "lng": 138.979,
    "elevation_m": 3,
    "driveMin": 180,
  ...
  },
  {
    ...
    "category": "lake",
    "area": "山梨県山中湖村",
    "congestion": {"factor": 1.1, "weekendOnly": true, "peak": {"from": 7, "to": 11, "factor": 1.5}, "note": "週末の中央道相模湖渋滞（7〜11時発が最悪帯・連休は大幅悪化）"},
    "lat": 35.4149,
    "lng": 138.8909,
    "elevation_m": 982,
    "driveMin": 100,
  ...
  },
  {
    ...
    "water": {
      "allowed": true,
      "depth": "遠浅・波穏やか（人工砂浜 約1km）",
      "swimBan": {
        "from": "07-11",
        "to": "08-31",
        "label": "海水浴場開設期間（例年7月第2土曜〜8月末・2026年は7/11〜8/31）"
      },
      "note": "オフシーズンは砂浜へのペット同伴可（リード着用・フン持ち帰り／公式FAQ明文）。入水自体の可否は明文なし。海水浴場開設期間中は砂浜へのペット立入が公式に禁止（確認日2026-08-03）"
    },
    "parking": [
      {
        "name": "柴口駐車場（E）",
        "fee": "1時間310円",
        "note": "1,064台・12時間最大1,550円。ほか磯浜駐車場（F）あり",
        "hours": "入庫4:00〜22:00（出庫24時間可）"
      }
    ],
    "restaurants": [],
    "surface": {
    ...
    "notes": "横浜市唯一の海水浴場。園内に無料ドッグラン「犬の遊び場」あり（登録不要・シーサイドライン海の公園南口駅高架下）。5〜6月や9〜10月の暑い日のオフシーズン海さんぽに",
    "official": {
      "url": "https://www.hama-midorinokyokai.or.jp/park/uminokouen/faq.php",
      "label": "海の公園 公式FAQ（ペット規定）"
    },
    "hours": {
      "open": "終日",
      "closed": null,
  ...
  },
  {
    ...
    "water": {
      ...
      "swimBan": {
        "from": "07-03",
        "to": "09-06",
        "label": "海水浴場開設期間（2026年は7/3〜9/6・開場9〜17時）"
      },
      "note": "市条例により開設期間中の開場時間内（9〜17時）は砂浜への犬の持込禁止（ケージ等に入れれば可・補助犬除く）。オフシーズンは犬の散歩・水遊びスポットとして定着（確認日2026-08-04）"
    },
    "parking": [
      {
        "name": "逗子海岸ロードオアシス駐車場（県道路公社）",
        "fee": "30分100円（7・8月と年末年始は200円）",
        "note": "74台・提携店500円以上利用で60分無料。市営駐車場はなし",
        "hours": "入庫4:00〜20:00（出庫24時間）"
      }
    ],
    "restaurants": [],
    "surface": {
    ...
    "notes": "波が穏やかで犬の海デビュー向きと評判の浜。オフシーズン（9月上旬〜7月上旬）が犬連れの季節",
    "official": {
      "url": "https://www.city.zushi.kanagawa.jp/shiminkatsudo/kanko/1007363/1004379/1014343.html",
      "label": "逗子市公式（海水浴場）"
    },
    "hours": {
      "open": "終日",
  ...
  },
  {
    ...
    "water": {
      ...
      "swimBan": {
        "from": "07-04",
        "to": "08-31",
        "label": "海水浴場開設期間（2026年は7/4〜8/31・開設時間8:30〜17時）"
      },
      "note": "海水浴場ルール第26条により開設時間中はペットを連れての入場自体が禁止（令和6年度版で確認）。開設時間外・海水浴場区域外は対象外。西側の柳島海岸は通年犬さんぽの定番（明文なし・確認日2026-08-04）"
    },
    "parking": [
      {
        "name": "サザンビーチ駐車場（夏期・観光協会）",
        "fee": "1日2,000円（夏期）",
        "note": "計350台。通年の市営はビーチ直近になく周辺民間コインPを利用",
        "hours": "夏期営業"
      }
    ],
    "restaurants": [],
    ...
    "notes": "サザンC碑と烏帽子岩で有名な茅ヶ崎の顔。オフシーズンと早朝・夕方が犬連れの時間帯",
    "official": {
  ...
  },
  {
    ...
    "water": {
      ...
      "swimBan": {
        ...
        "to": "03-06",
        "label": "潮干狩り場の営業期間外",
        "nowText": "⛔ <b>潮干狩り場は営業期間外</b>（2026年の営業は3/7〜7/31。営業日時は潮汐次第）",
        "offText": "🦪 <b>潮干狩りシーズン中</b>（2026年は3/7〜7/31・潮見表の確認必須）。犬同伴は実績多数（公式明文なし・要電話確認 0439-87-2121）"
      },
      "note": "犬同伴の公式明文はなし（禁止明文もなし・確認日2026-08-04）。リード付きの犬連れ潮干狩りレポートが多数。料金は大人2,200円（網袋付約2kg）・4歳〜小学生1,100円"
    },
    "parking": [
      {
        "name": "潮干狩場駐車場",
    ...
    "notes": "3〜7月限定の犬連れ潮干狩りスポット。営業日・時間は潮汐カレンダー次第なので事前に潮見表を確認。漁協公式サイトは閲覧不可のため市・観光協会ページで確認",
    "official": {
  ...
  },
  {
    ...
    "water": {
      ...
      "swimBan": {
        "from": "07-01",
        "to": "08-31",
        "label": "海水浴場開設期間（2026年は7/1〜8/31）",
        "soft": true
      },
      "note": "犬に関する明文規定は未確認（隣の片貝と同町のため、開設期間中の遊泳区域内は犬の遊泳不可の運用と考えられる・要確認）。飼い主は冬場に利用実績あり（夏場は未確認・確認日2026-08-04）"
    },
    "parking": [
      {
        "name": "町営駐車場（不動堂海水浴場）",
        "fee": "期間外無料",
        "note": "飼い主が冬場に利用実績あり。開設期間中は有料の可能性（要確認）",
        "hours": "終日"
      }
    ],
    "restaurants": [],
    ...
    "notes": "片貝中央海岸（掲載中）の南約2.5kmの隣浜。オフシーズンの九十九里さんぽに",
    "official": {
      "url": "https://www.town.kujukuri.chiba.jp/0000008988.html",
      "label": "九十九里町公式（海水浴場）"
    },
    "hours": {
      "open": "終日",
...
const RESTAURANTS = {
  ...
  "r011": {
    ...
    "hours": {
      "open": "11:30〜18:00",
      "closed": "火・水曜定休",
      "note": "2025年2月に青梅駅前から釜の淵公園近く（本町117）へ移転済み（確認日2026-08-04）"
    }
  },
  "r012": {
    "id": "r012",
  ...
  "r080": {
    ...
    "hours": {
      "open": "9:00〜18:00",
      "closed": null,
      "note": "2025年3月の指定管理者交代で2階フードコートの一部店舗が閉店・構成変更あり（確認日2026-08-04）"
    }
  },
  "r081": {
    "id": "r081",
  ...
  "r121": {
    "id": "r121",
    "name": "BAYSIDE CAFE（BAYSIDE SHARE 三浦海岸）",
    "area": "神奈川県三浦市",
    "policy": "テラスのみ",
    "leadOK": true,
    "lat": 35.1883,
    ...
    "hours": {
      "open": "10:00〜20:00",
      "closed": null,
      "note": "年中無休・L.O.19:00。カフェ&コワーキング「BAYSIDE SHARE」のオープンデッキ。店内可とする情報もあり（要確認・確認日2026-08-03）"
    }
  },
  "r124": {
    "id": "r124",
  ...
  "r134": {
    ...
    "hours": {
      "open": "11:30〜15:00",
      "closed": "水曜定休",
      "note": "2026年2月に新店舗へ移転オープン（公式告知・新住所は公式サイト要確認・確認日2026-08-04）"
    }
  },
  "r135": {
    "id": "r135",
