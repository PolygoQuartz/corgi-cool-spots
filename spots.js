...
const SPOTS = [
  ...
  },
  {
    ...
    "water": {
      "allowed": true,
      "depth": "浅瀬中心・泳げる場所もあり（管理人確認）",
      "note": "犬の入水に関する公式明文は見当たらず（2026-08-03時点）。園のペット規定はリードまたはケージ・建物内は抱っこ（公式FAQ）。管理人訪問時はリードのまま川遊び・泳ぎができた（現地確認2026-08-01）"
    },
    "parking": [
      {
        "name": "園内駐車場",
    ...
    "surface": {
      "shade": "多い",
      "ground": "川沿いはほぼ木陰・芝生や土の道あり（管理人確認）"
    },
    "photo": {
      "url": "assets/visits/visit-2026-08-01-9723/01.jpg",
      "credit": "管理人撮影（2026-08-01）"
    },
    "notes": "童謡『夕焼小焼』ゆかりの八王子市の入園施設。園内を北浅川が流れる。開園9:00〜16:30（11〜2月は16:00まで・GW/7-8月の土日祝/お盆は18:00まで）・年中無休。夏休みの川遊び場入口付近は混雑するが、奥に静かな区画あり（管理人確認2026-08-01）",
    "official": {
...
const RESTAURANTS = {
  ...
  "r013": {
    ...
    "hours": {
      "open": "10:00〜16:00",
      "closed": null,
      "note": "カフェ44APARTMENTの時間。土日祝9:00〜18:00・煮込み炎家とドッグテラスは11:00〜16:00（公式・確認日2026-08-03）・駐車場約10台で近隣パーキングなし（管理人確認2026-08-02）"
    }
  },
  "r014": {
    "id": "r014",
